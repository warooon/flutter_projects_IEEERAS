...
class _MyHomePageState extends State<MyHomePage> {
  ...
  int categoryIndex = 0;
  Color businessColor = const Color.fromRGBO(183, 10, 215, 1.0);
  Color personalColor = const Color.fromRGBO(56, 76, 129, 1.0);
  Color educationColor = const Color.fromRGBO(56, 76, 129, 1);
                  ...
                  child: IconButton(
                    onPressed: () {
                      ...
                      if (textEditingController.text.length > 0 &&
                          textEditingController.text.length < 25) {
                        addTasks();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: const Color(0xFF2279FC),
      ),
      drawer: Drawer(
        child: Container(
          ...
          child: ListView(
            children: [
              const DrawerHeader(
                ...
                "G M I N D E R",
                style: TextStyle(
                    fontSize: 35, color: Color.fromRGBO(144, 173, 241, 1)),
              ))),
              ListTile(
                title: Container(
                    width: 100,
                ...
                title: Container(
                    ...
                    child: const Row(
                      children: [
                        ...
                        Text(
                          "Design inspired from Alex Arutuynov @dribble",
                          style: TextStyle(
                              color: Color.fromRGBO(144, 173, 241, 1),
                              fontSize: 10),
                        ),
      ...
      appBar: AppBar(
        backgroundColor: const Color.fromRGBO(52, 80, 161, 1.0),
        elevation: 0.0,
        leading: const Icon(
          Icons.menu_sharp,
          color: Color.fromRGBO(144, 173, 241, 1),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          setState(() {
                            categoryIndex = 0;
                            businessColor =
                                const Color.fromRGBO(183, 10, 215, 1.0);
                            personalColor =
                                const Color.fromRGBO(56, 76, 129, 1);
                            educationColor =
                                const Color.fromRGBO(56, 76, 129, 1);
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Text(
                                    "${db.tasks[0].length} tasks",
                                    style: const TextStyle(
                                        color:
                                            Color.fromRGBO(144, 173, 241, 1.0),
                                        fontSize: 17),
                                  ),
                                ),
                                const Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          setState(() {
                            categoryIndex = 1;
                            personalColor =
                                const Color.fromRGBO(36, 126, 238, 1);
                            businessColor =
                                const Color.fromRGBO(56, 76, 129, 1);
                            educationColor =
                                const Color.fromRGBO(56, 76, 129, 1);
                      ...
                      child: GestureDetector(
                        onTap: () {
                          setState(() {
                            categoryIndex = 2;
                            educationColor =
                                const Color.fromRGBO(183, 10, 215, 1);
                            businessColor =
                                const Color.fromRGBO(56, 76, 129, 1);
                            personalColor =
                                const Color.fromRGBO(56, 76, 129, 1);
              ...
              child: Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return TaskWidget(
                        taskContent: db.tasks[categoryIndex][index],
                        done: db.checks[categoryIndex][index],
                        onCheckBoxChanged: () {
                          db.checks[categoryIndex][index] =
                              !db.checks[categoryIndex][index];
                          db.saveData();
                        },
                        deleteFromList: () {
        ...
        child: Container(
          ...
          child: Row(
            children: <Widget>[
                ...
                child: widget.done
                    ? IconButton(
                        icon: Icon(Icons.check_circle,
                            size: 35, color: widget.checkCircleColor),
              ...
              Text(
                this.widget.taskContent,
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 19,
                    decoration: this.widget.done
