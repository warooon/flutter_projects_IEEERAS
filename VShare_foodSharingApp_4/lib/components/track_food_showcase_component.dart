...
class TrackFoodShowcaseComponent extends StatelessWidget {
  String id;
  String foodName;
  String foodQuantity;
  LatLng location;
  ...
  String donatorName;
  String donatorNumber;
  String date;
  String time;
  int donatorPoints;
  late String imageUrl;

  TrackFoodShowcaseComponent({
    super.key,
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          var qrCodeKey = donatorId + id + uid;

                          if (qrScanResult == qrCodeKey) {
                            ...
                            SnackBarComponent.showSnackBar(
                                context, "success", "QR Matched");
                          } else {
                            SnackBarComponent.showSnackBar(
                                context, "error", "QR Code doesn't match");
                          }
                        },
                        child: Container(
                          padding: const EdgeInsets.symmetric(
